...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"PrivateMessageCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"PrivateMessageCell" forIndexPath:indexPath];
